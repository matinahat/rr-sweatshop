...
describe RestfulResource::Sweatshop::Unique do
  describe '#unique' do
    before(:each) do
      @ss = RestfulResource::Sweatshop
      RestfulResource::Sweatshop::UniqueWorker.class_eval do
    ...
    describe 'when the block has an arity less than 1' do
      ...
      it 'raises when a unique value cannot be generated' do
        ...
        }.should raise_error(RestfulResource::Sweatshop::Unique::TooManyTriesException)
      end
    end
  ...
  describe 'when mixing into an object' do
    it 'only the unique method is added to the public interface' do
      ...
      obj.extend(RestfulResource::Sweatshop::Unique)
